...
pub fn hugo_frontmatter(
    ...
    if title_value.is_none() || title_value.unwrap().is_null() {
        ...
        let new_title_value =
            Value::String(infer_note_title_from_path(&context.current_file()).to_string());
    ...
    if context
        .frontmatter
        .contains_key(&Value::String("alias".to_string()))
    {
        context
            .frontmatter
            .remove(&Value::String("alias".to_string()));
    }
    if context
        .frontmatter
        .contains_key(&Value::String("aliases".to_string()))
    {
        context
            .frontmatter
            .remove(&Value::String("aliases".to_string()));
    }
    ...
    context
        .frontmatter
        .insert(Value::String("date".to_string()), new_created_value);
    ...
    context
        .frontmatter
        .insert(Value::String("lastmod".to_string()), new_modified_value);
    ...
    if !pub_value.is_none() && pub_value.unwrap().is_bool() {
        ...
        context
            .frontmatter
            .insert(Value::String("draft".to_string()), new_pub_value);
    }
